def A_Ex7(file):
    ...
    for l in f:
        ...
        if int(data[2]) > int(data[3]):
            d[data[0]] = d.get(data[0],0) + 3
            d[data[1]] = d.get(data[1],0)
        elif int(data[2]) < int(data[3]):
            d[data[0]] = d.get(data[0],0)
            d[data[1]] = d.get(data[1],0) + 3
        else:
            d[data[0]] = d.get(data[0],0) + 1
            d[data[1]] = d.get(data[1],0) + 1
