def Ex5(file):
    ...
    for r in f:
        r = r.strip()
        if re.match(pattern_auto,r) and len(r)==7:
            d['auto'] += 1
        elif re.match(pattern_moto,r) and len(r)==7:
            d['moto'] += 1
        elif re.match(pattern_ciclomotore1,r) and len(r)==5:
            d['ciclomotore1'] += 1
        elif re.match(pattern_ciclomotore2,r) and len(r)==6:
            d['ciclomotore2'] += 1
        else:
            d['errata']+=1
