def A_Ex7(file):
    ...
    for partita in fin:
        ...
        if int(partita[2])>int(partita[3]):
            d[partita[0]]=d.get(partita[0],0)+3
            d[partita[1]]=d.get(partita[1],0)+0
        elif partita[2]==partita[3]:
            d[partita[0]]=d.get(partita[0],0)+1
            d[partita[1]]=d.get(partita[1],0)+1
        elif partita[2]<partita[3]:
            d[partita[0]]=d.get(partita[0],0)+0
            d[partita[1]]=d.get(partita[1],0)+3    
    return d
