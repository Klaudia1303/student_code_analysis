#5) Scrivere un programma python che chiede in input all’utente una sequenza di stringhe, una per una in maniera iterativa, terminando la richiesta di inserimento in input quando viene immessa una stringa
...
s=str(s)
while s.isalpha() or not s.islower():
    print(s[0]+s[len(s)-1])
    s=input("Inserisci stringa: ")
print(s)
