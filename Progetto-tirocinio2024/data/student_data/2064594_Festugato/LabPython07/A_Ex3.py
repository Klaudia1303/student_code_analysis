def A_Ex3(l,n):
    ...
    if l == '':
        risultato = ''
         ...
         for i in l: #itera sugli elemnti di l
            
            stringa_interna = i #sottostringa
            print(i)
        

            for l in range(len(stringa_interna)):#itera sulle posizoni di i
            
                       if l == n:
                           carattere = stringa_interna[l]
                           risultato += carattere
                           break
                       elif n > (len(stringa_interna)-1):#n maggiore degli indici
                           risultato += '!'
                           break
    return risultato
