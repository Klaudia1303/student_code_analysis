def A_Ex7(file):
    ...
    for i in range(1,len(sv)):
        ...
        Numero_gol_Squadra1=int(sv[i][2])
        Numero_gol_Squadra2=int(sv[i][3])
        Nome_Squadra1=sv[i][0]
        Nome_Squadra2=sv[i][1]

        if Numero_gol_Squadra1>Numero_gol_Squadra2:
            d[Nome_Squadra1]=d.get(Nome_Squadra1, 0)+3

        elif Numero_gol_Squadra1<Numero_gol_Squadra2:
            d[Nome_Squadra2]=d.get(Nome_Squadra2, 0)+3

        elif Numero_gol_Squadra1==Numero_gol_Squadra2:
            d[Nome_Squadra1]=d.get(Nome_Squadra1, 0)+1
            d[Nome_Squadra2]=d.get(Nome_Squadra2, 0)+1
