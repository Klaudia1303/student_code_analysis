def Ex5(file):
    ...
    patternA = r'\b[A-Z]{2}[0-9]{3}[A-Z]{2}\b'
    patternM = r'\b[A-Z]{2}[0-9]{5}\b'
    patternC1 = r'\b[A-Z0-9]{5}\b'
    patternC2 = r'\b[A-Z0-9]{6}\b'
    for r in f.readlines():
        if re.match(patternA, r):
            d['auto'] += 1
        elif re.match(patternM, r):
            d['moto'] += 1
        elif re.match(patternC1, r):
            d['ciclomotore1'] += 1
        elif re.match(patternC2, r):
            d['ciclomotore2'] += 1
        else:
            d['errata'] += 1
    return d
