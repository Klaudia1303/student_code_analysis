def Ex4(file):
    ...
    var3 = {}
    for var4 in var2:
        var5 = "".join(var4.strip().split())
        var6 = var5.strip().split(',')
        if var6[0] not in var3:
            var3[var6[0]] = []
            #var3[var6[0]].append(var6[1])
            var3[var6[0]].append(var6[2])
        elif var3[var6[0]][1] == var6[1]:
            var3[var6[0]].remove(var6[1])
            var3[var6[0]].append(var6[2])
    return var3
