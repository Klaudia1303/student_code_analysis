def Ex5(file):
    ...
    patternciclo1=r"\b[A-Z0-9]{5}\b"
    patternciclo2=r"\b[A-Z0-9]{6}\b"

    for elem in f.readlines():
        if re.match(patternauto, elem):
            d["auto"]=d["auto"]+1
        elif re.match(patternmoto, elem):
            d["moto"]=d["moto"]+1
        elif re.match(patternciclo1, elem):
            d["ciclomotore1"]=d["ciclomotore1"]+1
        elif re.match(patternciclo2, elem):
