...
#di tutte e sole le coppie (x,n) tali che x è una stringa di l ed n è il numero di volte
#che la stringa x appare in l. Ad esempio, se l=['jkl', 'h', 'plqa', 'jkl', 'h', 'xkj'],
#allora la funzione deve restituire l’insieme {('jkl',2), ('h',2), ('plqa',1), ('xkj',1)}.
