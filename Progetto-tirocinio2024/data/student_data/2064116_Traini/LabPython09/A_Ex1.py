#Scrivere una funzione che prende in ingresso una stringa fileName, nome di un file di testo, e 
#restituisce il numero totale di caratteri alfabetici contenuti nel file.
def A_Ex1(fileName):
    a=open(fileName,encoding='UTF-8').read()
    s=a.split()
    conta=0
    for i in s:
        for j in i:
